...
class Policy(nn.Module):
    ...
    def encode(self, observation, reward, actions, previous_latent_state, predicted_times, savedir=None):
        """
    ...
    def forward(self, current_memory, deterministic=False, predicted_times=None, savedir=None):
        """
        ...
        # print("Latent state from model")
        # print(latent_state._items)
        ...
        # print("print encoding loss used for loss update")
        # print(policy_return.total_encoding_loss)
        ...
        # print("Encoded state from model used for critic linear")
        # print(encoded_state)
